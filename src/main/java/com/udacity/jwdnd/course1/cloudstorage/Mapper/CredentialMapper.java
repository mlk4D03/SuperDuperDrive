...
/**
 * Performs multiple database queries for the credential table.
 */
@Mapper
public interface CredentialMapper {
    ...
    public int updateCredentials(String url, String password, String username, Integer credentialid, String key);
